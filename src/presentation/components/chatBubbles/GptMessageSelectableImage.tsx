...
export function GptMessageSelectableImage({ text, imageAlt, imageUrl, onImageSelected }: Props) {
      ...
      <div className="flex flex-row items-start">
        ...
        <div className="flex flex-col gap-3 justify-center align-middle">
          <canvas 
            ...
            />
            <button className='btn-primary w-50' onClick={resetCanva} >Borrar selección</button>
          {/* <span>{text}</span>
          <img
            src={imageUrl}
            alt={imageAlt}
